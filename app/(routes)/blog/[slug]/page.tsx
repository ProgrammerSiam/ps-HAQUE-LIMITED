        ...
        <div className="flex flex-col sm:flex-row gap-[73px]">
          ...
          <div className="sm:w-[276px] w-full flex flex-col gap-[34px]">
            ...
            <div className="">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-[#686868]">Designation</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              {/* Tags Section */}
              <div className="">
                <p className="ext-base font-medium text-[#686868]">Tag(s):</p>
            ...
            {/* Contents Section */}
            <div className="">
              <h4 className="text-lg font-bold text-[#686868]">Contents</h4>
            ...
            {/* Share Section */}
            <div className="mt-5">
              <h4 className="font-semibold text-gray-900 mb-4">Share</h4>
            ...
            <div className="">
              ...
              <div id="heritage" className="">
                ...
                <p className="md:text-[20px] text-base text-[#686868] text-justify mb-4">
                  Haque's culinary journey began decades ago, rooted in a vision
                  to bring authentic, delicious, and high-quality food products
                  to the tables of Bangladeshi families. From the very start, we
                  have believed that food is more than nourishment—it's culture,
                  comfort, and connection.
                  <br /> Founded with humble beginnings, Haque started as a
                  family business with a passion for baking and confectionery.
                  Over the years, our small kitchen has evolved into a
                  large-scale production facility, backed by world-class
                  equipment and a team of dedicated professionals. But one thing
                  remains unchanged: our commitment to quality and authenticity.
                </p>
              </div>
              ...
              <div id="now" className="mb-12">
                ...
                <p className="md:text-[20px] text-base text-[#686868] text-justify mb-4">
                  Today, Haque has grown far beyond its roots. What began as a
                  small local brand is now a recognized name in both national
                  and international markets. Our products are found in homes,
                  shops, and supermarkets not only across Bangladesh but also in
                  regions with growing demand for quality Bangladeshi food
                  products.
                  <br /> With a strong distribution network and a focus on
                  export-ready standards, Haque continues to expand its presence
                  across Asia, the Middle East, and beyond. This growth isn't
                  just about scale—it's about maintaining the same level of
                  trust, taste, and tradition that defined us from day one.{" "}
                  <br />
                  Our expansion proves that locally crafted food, made with care
                  and consistency, can compete on a global stage—bringing the
              ...
              <div id="quality" className="mb-12">
                ...
                <p className="md:text-[20px] text-base text-[#686868] text-justify mb-4">
                  Behind every successful product is a meticulous process—and at
                  Haque, quality is never compromised. Our factories are
                  equipped with modern, automated production lines to ensure
                  consistency, hygiene, and efficiency. We follow strict
                  international food safety protocols including ISO and HACCP
                  certifications.
                  <br /> We source ingredients with care, often partnering with
                  local farmers and international suppliers known for their
                  purity and sustainability. Our goal is not just to make tasty
                  food, but food you can trust.
                  <br /> Each product is tested at multiple stages, from raw
                  materials to finished packaging, by our in-house quality
                  assurance team. This attention to detail helps us maintain our
                  long-standing reputation as one of Bangladesh's most reliable
                  food manufacturers.
                </p>
              </div>
            </div>

...
export default async function ProductDetailsPage({
    ...
    return (
        <section className="h-svh !pb-0">
            <div className="flex gap-3 h-full">
                <div className="basis-[60%] flex h-full">
                    <div className="h-full w-[461.21px] bg-[#DE2332]">
                        {/* <Image
                                src={"/assets/products-img/noise-bg.png"}
                                alt={"noise-bg"}
                                width={1500}
                                height={1500}
                    ...
                    <div className="border pt-8">
                        <h1 className="border rotate-90 text-[180px] font-bold text-black/10">
                            {product.title}
                        </h1>
                    </div>
                </div>

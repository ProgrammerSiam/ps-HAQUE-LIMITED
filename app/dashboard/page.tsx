...
import { Blog, Brand, databaseService } from "@/lib/supabaseService";
    ...
    useEffect(() => {
        async function fetchData() {
            try {
                ...
                const brandsResponse = await databaseService.brands.getAll();
                setBrands(brandsResponse);

                //! ======= there is no /api/admins endpoint in the current code
                //! so, there is no point of calling it =======

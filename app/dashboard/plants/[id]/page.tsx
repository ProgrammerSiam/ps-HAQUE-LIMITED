...
export default function EditPlant({ params }: PageProps) {
  const router = useRouter();
  ...
  // Load plant data once we have the id
  useEffect(() => {
  ...
  // Show loading while resolving params or loading plant
  if (isLoading || !id) {
    return (
      <PageLayout title="Edit Plant">
        <div className="flex items-center justify-center h-64">

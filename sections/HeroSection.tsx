...
//     description:
//       "Leading biscuit, confectionery, soap and battery manufacturer in Bangladesh.",
...
//     description:
//       "Delivering excellence through innovation and quality since our inception.",
...
//       {/* Navigation Arrows */}
//       <div
//         className={`absolute hidden inset-x-0 top-1/2 md:flex items-center justify-between px-4 transform -translate-y-1/2 transition-opacity duration-500 ${isHovered ? "opacity-100" : "opacity-0"}`}
//       >
//         <motion.button
...
//             className="h-6 w-6 text-white transition-transform duration-300 group-hover/nav:-translate-x-1"
//             fill="none"
//             viewBox="0 0 24 24"
//             stroke="currentColor"
//           >
...
const Hero = () => {
  return (
    <section className="relative h-screen w-full text-white mb-[-1px]">
      {/* Background Image */}
      <Image
        src={hero}
        alt="A.T. Haque Limited"
        fill
      ...
      <div className="relative z-10 flex flex-col justify-center items-center h-full text-center px-4">
        {/* Top Badge */}
        <div className="mb-4 bg-red-600 text-white text-xs px-4 py-1 rounded-full uppercase font-medium tracking-wide">
          Trusted By Millions Since 1947
        </div>

        {/* Heading */}
        <h1 className="text-4xl md:text-6xl font-bold mb-4">
          A.T. <span className="text-red-600">HAQUE</span> LIMITED
        </h1>

        {/* Subtitle */}
        <p className="max-w-xl text-base md:text-lg text-white/90 mb-8 leading-relaxed">
          We are a top manufacturer of biscuits, confectionery, soap, and batteries in Bangladesh, dedicated to quality and making everyday life better for our customers.
        </p>

        {/* CTA Button */}
        <Link href="/products">
          <button className="bg-transparent hover:bg-white text-white hover:text-black border border-white px-6 py-3 rounded-full text-sm font-medium transition-all">

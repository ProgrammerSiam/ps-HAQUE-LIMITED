    ...
    <section className="relative overflow-hidden bg-white py-16 lg:pt-4 lg:pb-10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        >
          {/* Gradient Masks */}
          <div
            className="pointer-events-none absolute left-0 top-0 z-10 w-24 bg-gradient-to-r from-white"
            style={{ height: "100%" }}
          />
          <div
            className="pointer-events-none absolute right-0 top-0 z-10 w-24 bg-gradient-to-l from-white"
            style={{ height: "100%" }}
          />
